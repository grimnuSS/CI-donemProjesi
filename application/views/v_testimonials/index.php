	...
	<div class="container-fluid page-body-wrapper">
		...
		<div class="main-panel">
			...
			<div class="content-wrapper">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">Bonservisler</h4>
						<div class="row">
							<div class="col-12">
								<div class="table-responsive">
									<div id="order-listing_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
										<div class="row">
											...
											<div class="col-sm-12 col-md-6">
												<a href="<?php echo base_url("Testimonials/new_form")?>" class="btn btn-outline-primary form-control">Ekle</a>
											</div>
										</div>
												...
												<table id="order-listing" class="table dataTable no-footer"
													...
													<tr>
														...
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															...
															style="width: 174.75px;">Başlık
														</th>
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															rowspan="1" colspan="1"
															aria-label="Açıklama: activate to sort column ascending"
															style="width: 174.75px;">Açıklama
														</th>
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															rowspan="1" colspan="1"
															aria-label="Tam İsim: activate to sort column ascending"
															style="width: 174.75px;">Tam İsim
														</th>
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															rowspan="1" colspan="1"
															aria-label="Şirket: activate to sort column ascending"
															style="width: 174.75px;">Şirket
														</th>
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															rowspan="1" colspan="1"
													...
													<?php foreach ($testimonials as $testimonial) { ?>
														<tr class="odd">
															<td class="sorting_1"><?php echo $testimonial->id; ?></td>
															...
															<td><?php echo $testimonial->img_url; ?></td>
															<td><?php echo $testimonial->rank; ?></td>
															<td>
																<label class="badge badge-info"><?php echo $testimonial->is_active==0 ? "Pasif" : "Aktif"; ?></label>
															</td>
															<td><?php echo $testimonial->created_at; ?></td>
															<td>
																<a href="<?php echo base_url("Testimonials/delete/" . $testimonial->id)?>" class="btn btn-light">Sil</a>
																<a href="<?php echo base_url("Testimonials/update_form/" . $testimonial->id)?>" class="btn btn-light">Düzenle</a></td>
															</td>
														</tr>
													<?php } ?>
													</tbody>
