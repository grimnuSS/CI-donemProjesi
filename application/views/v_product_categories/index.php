												...
												<table id="order-listing" class="table dataTable no-footer"
													...
													<tr>
														...
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															rowspan="1" colspan="1"
															aria-label="Ürün Kategorisi: activate to sort column ascending"
															style="width: 174.75px;">Ürün Kategorisi
														</th>
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															rowspan="1" colspan="1"
													...
													<?php foreach ($product_categories as $product_category) { ?>
														<tr class="odd">
															<td class="sorting_1"><?php echo $product_category->id; ?></td>
															<td><?php echo $product_category->title; ?></td>
															<td>
																<label class="badge badge-info"><?php echo $product_category->is_active==0 ? "Pasif" : "Aktif"; ?></label>
															</td>
