								...
								<div class="table-responsive">
									<div id="order-listing_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
										<div class="row">
											...
											<div class="col-sm-12 col-md-6">
												<a href="<?php echo base_url("References/new_form")?>" class="btn btn-outline-primary form-control">Ekle</a>
											</div>
										</div>
												...
												<table id="order-listing" class="table dataTable no-footer"
													...
													<tr>
														...
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															...
															style="width: 130.109px;">Açıklama
														</th>
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															rowspan="1" colspan="1"
													...
													<?php foreach ($references as $reference) { ?>
														<tr class="odd">
															<td class="sorting_1"><?php echo $reference->id; ?></td>
															<td><?php echo $reference->img_url; ?></td>
															<td><?php echo $reference->title; ?></td>
															<td><?php echo $reference->description; ?></td>
															<td><?php echo $reference->rank; ?></td>
															<td>
																<label class="badge badge-info"><?php echo $reference->is_active==0 ? "Pasif" : "Aktif"; ?></label>
															</td>
															<td><?php echo $reference->created_at; ?></td>
															<td>
																<a href="<?php echo base_url("References/delete/" . $reference->id)?>" class="btn btn-light">Sil</a>
																<a href="<?php echo base_url("References/update_form/" . $reference->id)?>" class="btn btn-light">Düzenle</a></td>
															</td>
														</tr>
													<?php } ?>
													</tbody>
