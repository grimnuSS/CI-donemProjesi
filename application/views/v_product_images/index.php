	...
	<div class="container-fluid page-body-wrapper">
		...
		<div class="main-panel">
			...
			<div class="content-wrapper">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">Ürün Resimleri</h4>
						<div class="row">
							<div class="col-12">
								<div class="table-responsive">
									<div id="order-listing_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
										<div class="row">
											...
											<div class="col-sm-12 col-md-6">
												<a href="<?php echo base_url("Product_Images/new_form")?>" class="btn btn-outline-primary form-control">Ekle</a>
											</div>
										</div>
												...
												<table id="order-listing" class="table dataTable no-footer"
													...
													<tr>
														...
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															rowspan="1" colspan="1"
															aria-label="Ürün ID #: activate to sort column ascending"
															style="width: 174.75px;">Ürün ID #
														</th>
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															rowspan="1" colspan="1"
														...
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															rowspan="1" colspan="1"
															aria-label="Kapak Resmi: activate to sort column ascending"
															style="width: 130.109px;">Kapak Resmi
														</th>
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															rowspan="1" colspan="1"
															aria-label="Resim Linki: activate to sort column ascending"
															style="width: 130.109px;">Resim Linki
														</th>
														<th class="sorting" tabindex="0" aria-controls="order-listing"
															rowspan="1" colspan="1"
													...
													<?php foreach ($product_images as $product_image) { ?>
														<tr class="odd">
															<td class="sorting_1"><?php echo $product_image->id; ?></td>
															<td><?php echo $product_image->product_id; ?></td>
															<td><?php echo $product_image->rank; ?></td>
															<td>
																<label class="badge badge-warning"><?php echo $product_image->is_cover==0 ? "Evet" : "Hayır"; ?></label>
															</td>
															<td><?php echo $product_image->img_url; ?></td>
															<td>
																<label class="badge badge-info"><?php echo $product_image->is_active==0 ? "Pasif" : "Aktif"; ?></label>
															</td>
															<td><?php echo $product_image->created_at; ?></td>
															<td>
																<a href="<?php echo base_url("Product_Images/delete/" . $product_image->id)?>" class="btn btn-light">Sil</a>
																<a href="<?php echo base_url("Product_Images/update_form/" . $product_image->id)?>" class="btn btn-light">Düzenle</a></td>
															</td>
														</tr>
													<?php } ?>
													</tbody>
