											...
											<div class="col-sm-12">
												<table id="order-listing" class="table dataTable no-footer"
													...
													<?php foreach ($services as $service) { ?>
														<tr class="odd">
															<td class="sorting_1"><?php echo $service->id; ?></td>
															<td><?php echo $service->img_url; ?></td>
															<td><?php echo $service->title; ?></td>
															<td><?php echo $service->url; ?></td>
															<td><?php echo $service->description; ?></td>
															<td><?php echo $service->rank; ?></td>
															<td>
																<label class="badge badge-info"><?php echo $service->is_active==0 ? "Pasif" : "Aktif"; ?></label>
															</td>
															<td><?php echo $service->created_at; ?></td>
															<td>
																<a href="<?php echo base_url("Services/delete/" . $service->id)?>" class="btn btn-light">Sil</a>
																<a href="<?php echo base_url("Services/update_form/" . $service->id)?>" class="btn btn-light">Düzenle</a></td>
															</td>
														</tr>
													<?php } ?>
													</tbody>
