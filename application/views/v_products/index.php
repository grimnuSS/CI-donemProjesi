								...
								<div class="table-responsive">
									<div id="order-listing_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
										<div class="row">
											...
											<div class="col-sm-12 col-md-6">
												<a href="<?php echo base_url("Products/new_form")?>" class="btn btn-outline-primary form-control">Ekle</a>
											</div>
										</div>
												...
												<table id="order-listing" class="table dataTable no-footer"
													...
													<?php foreach ($products as $product) { ?>
														<tr class="odd">
															...
															<td><?php echo $product->img_url; ?></td>
															<td><?php echo $product->title; ?></td>
															<td><?php echo $product->description; ?></td>
															<td><?php echo $product->rank; ?></td>
															<td>
																<label class="badge badge-info"><?php echo $product->is_active==0 ? "Pasif" : "Aktif"; ?></label>
															</td>
															<td><?php echo $product->created_at; ?></td>
															<td>
																<a href="<?php echo base_url("Products/delete/" . $product->id)?>" class="btn btn-light">Sil</a>
																<a href="<?php echo base_url("Products/update_form/" . $product->id)?>" class="btn btn-light">Düzenle</a></td>
														</tr>
													<?php } ?>
													</tbody>
												</table>
